...
def pluginsinstallMysql():
    ...
    mysqlProcess = subprocess.Popen(
        ...
        stderr=subprocess.STDOUT)
    MYSQLSTATUS = True
    name = ['MySQL 5.1.73', 'MySQL 5.5.62', 'MySQL 5.6.42', 'MySQL 5.7.24', 'MySQL 8.0.13', 'MariaDB 5.5.62',
            'MariaDB 10.0.37', 'MariaDB 10.1.37', 'MariaDB 10.2.19', 'MariaDB 10.3.11'][int(version) - 1]
